...
REDIS_PASSWORD = os.getenv("REDIS_PASSWORD")  # Elimine el valor predeterminado

# Cree un diccionario de configuración
redis_config = {
    "host": REDIS_HOST,
    "port": REDIS_PORT,
    "db": REDIS_DB,
...
# Añada la contraseña solo si está configurada
if REDIS_PASSWORD:
