...
def create_article():
    ...
    category_slack_channel = Category.query.filter_by(id=category_id).first().slack_channel
    channel_test='C071142J72R'
    # Notify on Slack about the article
    send_NEWS_message_to_slack_channel(channel_id=channel_test, 
                                           title=new_article.title,
                                           article_url="Generated By Ai-Alpha Team.",
                                           content=new_article.content, 
                                           used_keywords=new_article.used_keywords, 
                                           image=new_article.image)
    print("Messege sent to Slack!")
